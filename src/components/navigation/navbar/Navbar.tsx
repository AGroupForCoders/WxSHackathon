  ...
  return (
    <nav className="py-4 px-8 md:px-32 flex justify-between absolute top-0 w-full">
      <div className="flex gap-8 items-center">
        <Link
          href="/"
          className="bg-accent-wdcc h-full w-[45px] rounded-full grid place-items-center"
        >
          {/* PLACEHOLDER FOR LOGO OF SOME KIND */}
          <span className="text-white text-xs">logo?</span>
        </Link>
        <div className="hidden md:flex gap-8 items-center">
          <Link href="/" className={`${navLinkStyles} hidden lg:inline`}>
            About
          </Link>
          ...
          <Link href="/gallery" className={navLinkStyles}>
            Gallery
          </Link>
          <Link href="/themes" className={navLinkStyles}>
            Past themes
          </Link>
          <Link href="/winners" className={navLinkStyles}>
            Past winners
          </Link>
          <Link href="/organisers" className={navLinkStyles}>
            Organisers
          </Link>
        </div>
      </div>
