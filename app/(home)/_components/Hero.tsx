      ...
      <div className="max-w-[700px] flex flex-col gap-6 mr-[-20%] pb-24">
        <div className="flex flex-col gap-4">
          ...
          <h1 className="text-6xl font-bold tracking-tight leading-[62px]">
            The <span className="bg-linear-to-br from-wdcc-blue-40 to-sesa-teal-40 bg-clip-text text-transparent pb-[10px]"
          >biggest</span
        ...
        <div className="text-xl">
          <p className="text-2xl font-bold tracking-tight leading-tight bg-linear-to-r from-andrew-amethyst-50 to-abbey-apricot-40 text-transparent bg-clip-text w-fit">A vibrant, in-person event in the heart of Auckland</p>
          <div className="flex gap-3 items-center font-medium text-lg">
            <p>Location, Region of Auckland here</p>
            <div className="w-[5px] h-[5px] bg-accent-wdcc rounded-full">
